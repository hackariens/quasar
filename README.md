# Welcome to @hackariens/quasar 👋

![Version](https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000)
![Documentation](https://img.shields.io/badge/documentation-yes-brightgreen.svg)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/hackariens/quasar/graphs/commit-activity)
![Continuous Integration](https://github.com/hackariens/quasar/actions/workflows/ci.yml/badge.svg?branch=develop)
...
```sh
git clone --recursive git@github.com:hackariens/quasar.git quasar
cd quasar
```
...
Feel free to check
[issues page](https://github.com/hackariens/quasar/issues).
You can also take a look at the
[contributing guide](https://github.com/hackariens/quasar/blob/develop/CONTRIBUTING.md).
...
This project is
[MIT](https://github.com/hackariens/quasar/blob/develop/LICENSE) licensed.
