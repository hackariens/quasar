...
![Continuous Integration](https://github.com/hackariens/quasar/workflows/ci/badge.svg?branch=develop)
...
```sh
git clone --recurse-submodules git@github.com:hackariens/quasar.git quasar
cd quasar
```
